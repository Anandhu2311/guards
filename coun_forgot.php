...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->connect_error) {
        ...
        $sql = "SELECT * FROM counselors WHERE coun_email='$email'";
       
        $result = $conn->query($sql);
       
        if ($result && $result->num_rows === 1) {
            $user = $result->fetch_assoc();
            echo'<form id="form" method="POST" action="adv_sent_reset_otp.php">';
...
<head>
    ...
    <title>GuardSphere - Forgot Password</title>
...
<body>
    <div class="login-container">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            ...
            <p class="back-to-login">Remember your password? <a href="counselor_signin.php">Login here</a></p>
        </form>
    </div>
</body>
</html>