...
<body>
    ...
    <div class="form-group">
        ...
        <input type="email" id="email" name="adv_email" placeholder="Enter your email" required>
        <span class="error-message" id="emailError"></span>
    </div>

    <div class="form-group">
        <label for="password">Password</label>
        <input type="password" id="password" name="adv_password" placeholder="Enter your password" required>
    ...
    window.onpopstate = function () {
        ...
        window.location.href = "advisor_signin.php";
    };
</script>
